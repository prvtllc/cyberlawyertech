  ...
  return (
    <IndexLayout>
      <Helmet>
        ...
        <meta property="article:publisher" content="https://www.facebook.com/avmtech" />
        <meta property="article:author" content="https://www.facebook.com/avmtech" />
        ...
        {config.twitter && (
          <meta
            name="twitter:site"
            content={`@${config.twitter.split('https://twitter.com/cyberforensix')[1]}`}
          />
        )}
        {config.twitter && (
          <meta
